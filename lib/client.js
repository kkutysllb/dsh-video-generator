			...
			if (props.selected) {
				...
				return React.createElement("div", null,
						...
						React.createElement("table", { style: { borderCollapse: "collapse", fontSize: 12 } },
							React.createElement("thead", null,
								React.createElement("tr", null,
									...
									React.createElement("th", { style: { padding: "3px 8px", textAlign: "left" } }, t("statusRunning") && ""),
					...
					React.createElement("div", { className: "vg-card", style: { marginTop: 8 } },
						...
						previewGroups.length > 0 ? previewGroups : React.createElement("p", { className: "vg-hint" }, t("loading")),
					),
				);
			}
			// 列表态
				...
				React.createElement("form", {
					...
					React.createElement("div", { className: "vg-field" },
						...
						React.createElement("input", {
							...
							onChange: function (e) {
								props.setBudgetDraft({ threshold: Number(e.target.value), gates: budgetDraft.gates });
							},
						}),
					),
					React.createElement("div", { className: "vg-field" },
		...
		function makeStatefulComponent(t) {
			function Stateful() {
				...
				var onSaveBudget = function () {
					run(api("settings.update", {
						confirmThresholdCny: Number(budgetDraft.threshold),
						gateDefaults: budgetDraft.gates,
					}));
				};
